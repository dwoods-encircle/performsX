	...
	$("#feedbackForm").submit(function(event) {
	   ...
	   // $("#result").html('');
		...
		if (validate(this)) { 
			...
			$.ajax({
		        url: "https://script.google.com/macros/s/AKfycbw_8ADP09Q2Ajc6zsSgwssXsJvsxiq1vHcEXbF452nKcrXkoZI/exec",
		        type: "post",
		        data: values, 
		        success: function(){
		        	$('#loading').hide();
		        ...
		        error:function(){
		            ...
		            $("#form-message").html('Sorry, something has gone wrong. Please email support@encircle.co.uk');
